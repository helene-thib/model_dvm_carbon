"""
Script to perform a sensitivity analysis of bioenergetic parameters for a community of cephalopods (3cm)
...
### Generate Samples ###
param_values = sobol.sample(problem_ceph, 2**6) #N must be 2 power of n
...
if detritus == 0:
    for i, X in enumerate(param_values):
        ...
        d, e, mu, Csda, fac_swim, a_swim, RQ, a0, a1, a2, a3 = X
    ...
    ### SAVE THE OUTPUTS
    output_names = ["sobol_ceph_Ctot.txt", "sobol_ceph_Rtot.txt", "sobol_ceph_Cmax.txt", "sobol_ceph_Rmax.txt", "sobol_param_ceph.txt"]
    ...
    ##Load data
    path_param = path_to_results / "sobol_param_ceph.txt"
    path_Rmax = path_to_results / "sobol_ceph_Rmax.txt"
    path_Cmax = path_to_results / "sobol_ceph_Cmax.txt"
    ...
    for i, X in enumerate(param_values):
        ...
        ### SAVE THE OUTPUTS
    output_names = ["sobol_ceph_Resp.txt", "sobol_ceph_POC.txt", "sobol_ceph_pe_ratio200.txt"]
